...
def fit_gru(log_returns: pd.Series, window_size: int = 30, train_ratio: float = 0.8, batch_size: int = 32, epochs: int = 100, learning_rate: float = 0.001) -> tuple[GRUVolatilityModel, pd.DataFrame]:
